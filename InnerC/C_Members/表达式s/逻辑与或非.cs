...
namespace InnerC.C_Members.表达式s
{
    class 与 : 二元表达式
    {
        ...
        public 与(表达式 左边的表达式, 表达式 右边的表达式, char[] chars, int iLeft) : base(左边的表达式, 右边的表达式, chars, iLeft)
        {
    ...
    class 或 : 二元表达式
    {
        ...
        public 或(表达式 左边的表达式, 表达式 右边的表达式, char[] chars, int iLeft) : base(左边的表达式, 右边的表达式, chars, iLeft)
        {
