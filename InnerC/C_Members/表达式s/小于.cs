...
namespace InnerC.C_Members.表达式s
{
    class 小于 : 二元表达式
    {
        ...
        //public 小于(表达式 左边的表达式, 表达式 右边的表达式, char[] chars, int iLeft) : base(chars, iLeft)
        //{
        //    this.左边的表达式 = 左边的表达式;
        //    this.右边的表达式 = 右边的表达式;
        //}

        public 小于(表达式 左边的表达式, 表达式 右边的表达式, char[] chars, int iLeft) : base(左边的表达式, 右边的表达式, chars, iLeft)
        {
